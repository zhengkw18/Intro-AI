...
class RNN(nn.Module):
    def __init__(self, droprate, padding):
        ...
        self.encoder = nn.RNN(input_size=300, hidden_size=64, num_layers=2, bidirectional=False, dropout=droprate)
        self.decoder = nn.Linear(padding * 64, 8)
...
class BiLSTM(nn.Module):
    def __init__(self, droprate, padding):
        ...
        self.encoder = nn.LSTM(input_size=300, hidden_size=64, num_layers=2, bidirectional=True, dropout=droprate)
        self.decoder = nn.Linear(2 * padding * 64, 8)
...
class MLP(nn.Module):
    def __init__(self, droprate, padding):
        ...
        self.fc1 = nn.Linear(300 * padding, 512)
        self.drop = nn.Dropout(droprate)
